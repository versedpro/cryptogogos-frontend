...
const CustomRightArrow = ({ onClick, ...rest }) => {
    ...
    return <button onClick={() => onClick()} ><svg width="40" height="40" viewBox="0 0 40 40" fill="none" xmlns="http://www.w3.org/2000/svg">
    <g opacity="0.5">
    <path d="M0.499756 10C0.499756 4.7533 4.75305 0.5 9.99976 0.5H29.9998C35.2465 0.5 39.4998 4.75329 39.4998 10V30C39.4998 35.2467 35.2465 39.5 29.9998 39.5H9.99976C4.75305 39.5 0.499756 35.2467 0.499756 30V10Z" stroke="white"/>
    <path d="M13.7867 21.133L13.7649 21.128H23.133L20.188 24.1739C20.0438 24.3226 19.9647 24.524 19.9647 24.7354C19.9647 24.9469 20.0438 25.1469 20.188 25.2959L20.6463 25.7691C20.7904 25.9178 20.9824 26 21.1871 26C21.392 26 21.5841 25.9184 21.7282 25.7697L26.7765 20.5605C26.9212 20.4112 27.0003 20.2123 26.9998 20.0008C27.0003 19.788 26.9212 19.5891 26.7765 19.44L21.7282 14.2303C21.5841 14.0818 21.3921 14 21.1871 14C20.9824 14 20.7904 14.0819 20.6463 14.2303L20.188 14.7035C20.0438 14.8519 19.9647 15.0502 19.9647 15.2616C19.9647 15.4729 20.0438 15.6608 20.188 15.8093L23.1663 18.8722H13.7762C13.3543 18.8722 12.9998 19.2475 12.9998 19.6827V20.3518C12.9998 20.787 13.3648 21.133 13.7867 21.133Z" fill="white"/>
    </g>
    </svg>
    </button>;
  };
  ...
  const CustomLeftArrow = ({ onClick, ...rest }) => {
    ...
    return <button onClick={() => onClick()} ><svg width="40" height="40" viewBox="0 0 40 40" fill="none" xmlns="http://www.w3.org/2000/svg">
    <g opacity="0.5">
    <path d="M0.5 10C0.5 4.7533 4.7533 0.5 10 0.5H30C35.2467 0.5 39.5 4.75329 39.5 10V30C39.5 35.2467 35.2467 39.5 30 39.5H10C4.7533 39.5 0.5 35.2467 0.5 30V10Z" stroke="white"/>
    <path d="M26.213 18.867L26.2349 18.872H16.8667L19.8117 15.8261C19.956 15.6774 20.0351 15.476 20.0351 15.2646C20.0351 15.0531 19.956 14.8531 19.8117 14.7041L19.3535 14.2309C19.2094 14.0822 19.0174 14 18.8126 14C18.6077 14 18.4156 14.0816 18.2715 14.2303L13.2232 19.4395C13.0785 19.5888 12.9994 19.7877 13 19.9992C12.9994 20.212 13.0785 20.4109 13.2232 20.56L18.2715 25.7697C18.4156 25.9182 18.6076 26 18.8126 26C19.0174 26 19.2094 25.9181 19.3535 25.7697L19.8117 25.2965C19.956 25.1481 20.0351 24.9498 20.0351 24.7384C20.0351 24.5271 19.956 24.3392 19.8117 24.1907L16.8335 21.1278H26.2235C26.6454 21.1278 27 20.7525 27 20.3173V19.6482C27 19.213 26.635 18.867 26.213 18.867Z" fill="white"/>
    </g>
    </svg>
    </button>;
  };
                    ...
                    <Row>
                        <Col>
                            ...
                            <h3 className="thin-heading">
                                The NFT Trading Card Game the World has never seen.<br />
            ...
            <section className="distribution-section">
                <Container>
                    <Row>
                        <Col>
                            <h2>
                                <Button variant="outline-light"> <span></span> Live</Button>
