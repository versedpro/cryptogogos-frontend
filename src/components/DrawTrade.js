...
export default class DrawTrade extends React.Component {
    ...
    async loadContract() {
        return await new window.web3.eth.Contract([
          ...
          ], '0x369eEF69bCE3ECBA04C3195d70093132CcFd471c');
    }
                                                    ...
                                                    <div className="rocket-buttons">
                                                        ...
                                                        <div className="actions">
                                                            <div className="drawButton">
                                                                <img src={drawBtn} onClick={this.drawCard.bind(this)} />
                                                            </div>
                                                ...
                                                <Col lg="10" xs="12">
                                                    <div className="terms text-left">
                                                        ...
                                                        <div className="terms-content">
                                                            <p>
                                                                In 2021 the world became like in 1984. The human race got enslaved to nonsense NFT Art and bad Collectibles. 
                                                                Ugly Kitties and terrible Punks mesmerized humankind and stole their money. Seeking revenge for the unjust 
                                                                treatment of the true meaning of NFTs, the CryptoGOGOs are coming the far way from PLANET GOGO in the 
                                                                Metaverse to start a revolution. Alongside the GOGO-Rebellion (CryptoGOGO-Collectors), they bring back 
                                                                freedom and power to humankind by taking over the NFT WORLD.
                                                            </p>

                                                            <p>
                                                                In 2021 the world became like in 1984. The human race got enslaved to nonsense NFT Art and bad Collectibles. 
                                                                Ugly Kitties and terrible Punks mesmerized humankind and stole their money. Seeking revenge for the unjust 
                                                                treatment of the true meaning of NFTs,
                                                            </p>
                                                        </div>
                                                    </div>
                                                </Col>
